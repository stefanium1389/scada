...
export class AnalogOutputComponent implements OnInit {
  ...
  onSubmit() {
    ...
    if (name == '' || description == '' || address == '' || initial_value === '' || low_limit === '' || high_limit === '' || unit == ''
      || name == null || description == null || address == null || initial_value === null || low_limit === null || high_limit === null || unit == null) 
    {
